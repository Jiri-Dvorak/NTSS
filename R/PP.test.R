...
#'
#' @details The test statistic is either the cross K-function or the expectation of the
#' cross nearest-neighbor distance, see the paper Mrkvička et al. (2021).
#'
...
#' Y <- rpoispp(150)
#'
#' out1 <- PP.test(X=X, Y=Y, radius=0.5, statistic="K12", correction="torus", verbose=TRUE)
#' out1
#' plot(out1$GET.outcome)
#'
#' out2 <- PP.test(X=X, Y=Y, radius=0.5, statistic="ED12", correction="torus", verbose=TRUE)
#' out2
#'
#' @export
#'
